...
// This class is used to plot sensor chart based on the data recorded by smart service
class SensorProcessor(private val context: Context) {
    ...
    private val smartServiceSensorIndexKey = "sensor_index"
    ...
    private var smartServiceSensorIndex: Int
        get() {
            ...
            val index = recordingPrefs.getInt(smartServiceSensorIndexKey, 0)
