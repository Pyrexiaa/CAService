...
// This class is used to plot data on Audio Chart based on the data recorded by smart service
class AudioProcessor(
    ...
    // A local variable to keep track of the last index processed for display
    ...
    fun updateAudioSequence() {
        ...
        val latestRecorderFileIndex = (recorderIndex - 1 + maxCircularFiles) % maxCircularFiles
